...
![demo](assets/demo_capture.jpg)

> 손상 블록 탐지 시 바운딩박스 포함 이미지 자동 캡처 + CSV 로그 기록 (3초 중복 방지)

탐지 결과는 `detection_log.csv`에 자동 기록됩니다.

| 파일명 | 탐지시각 | 위치 | 신뢰도 | 탐지수 |
|--------|---------|------|-------|-------|
| capture_001_... | 20260607_174129 | 경기 안산시 상록구 사동 1621 | 0.910 | 1 |
| capture_002_... | 20260607_174136 | 경기 안산시 상록구 사동 1621 | 0.920 | 2 |
